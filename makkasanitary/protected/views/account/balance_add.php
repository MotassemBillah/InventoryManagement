...
$this->breadcrumbs = array(
    ...
    $type == AppConstant::CASH_DEPOSIT ? 'Deposit' : 'Withdraw'
);
$_value = $type == AppConstant::CASH_DEPOSIT ? AppConstant::CASH_IN : AppConstant::CASH_OUT;
?>
    ...
    <div class="col-md-4 col-sm-6">
        ...
        <div class="clearfix">
            <div class="form-group">
                ...
                <?php echo $form->textField($model, 'category', array('class' => 'form-control', 'readonly' => 'readonly', 'value' => $_value)); ?>
            </div>
            <div class="form-group">
