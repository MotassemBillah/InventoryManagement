                ...
                <form class="search-form" method="post" name="frmSearch" id="frmSearch">
                    <div class="input-group">
                        <div class="input-group-btn clearfix">
                            ...
                            <button type="button" id="search" class="btn btn-info"><?php echo Yii::t("strings", "Search"); ?>&nbsp;<img class="ajaxLoader" src="<?php echo Yii::app()->request->baseUrl; ?>/img/loading.gif" alt="Loading..." style="display: none;"></button>
                        </div>
                    </div>
                </form>
            </td>
            <td class="text-right wmd_30" style="position: relative;">
                <a class="btn btn-success btn-xs" href="<?php echo Yii::app()->createUrl(AppUrl::URL_CATEGORIES_CREATE); ?>"><i class="fa fa-plus"></i>&nbsp;<?php echo Yii::t("strings", "New"); ?></a>
