    ...
    <table width="100%">
        <tr>
            ...
            <td class="text-right wmd_30" style="position: relative;">
                <a class="btn btn-success btn-xs" href="<?php echo Yii::app()->createUrl(AppUrl::URL_PURCHASE_CREATE); ?>"><i class="fa fa-plus"></i>&nbsp;<?php echo Yii::t("strings", "New"); ?></a>
                <?php if ($this->hasUserAccess('purchase_delete')): ?>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered tbl_invoice_view">
                    <tr id="r_checkAll">
                        ...
                        <?php if ($this->hasUserAccess('purchase_delete') || $this->hasUserAccess('reset_invoice')): ?>
                    ...
                    foreach ($dataset as $data) :
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                } elseif ($data->status == AppConstant::ORDER_COMPLETE) {
                                    echo '<span class="label label-success">' . Yii::t("strings", AppConstant::ORDER_COMPLETE) . '</span>';
                                } else {
                                    echo '<span class="label label-warning">' . Yii::t("strings", $data->status) . '</span>';
                                }
                                ?>
                            </td>
                            <td class="text-center">
                                <?php if ($data->status == AppConstant::ORDER_PENDING): ?>
                                    <?php if ($this->hasUserAccess('purchase_edit')): ?>
                                        <a class="btn btn-info btn-xs" href="<?php echo $this->createUrl(AppUrl::URL_PURCHASE_EDIT, array('id' => $data->_key)); ?>"><?php echo Yii::t("strings", "Edit"); ?></a>
                                    <?php endif; ?>
                                    <?php if ($this->hasUserAccess('purchase_process')): ?>
                                    ...
                                    <?php endif; ?>
                                <?php endif; ?>
                                <?php if ($this->hasUserAccess('purchase_view')): ?>
                                    <a class="btn btn-primary btn-xs" href="<?php echo $this->createUrl(AppUrl::URL_PURCHASE_VIEW, array('id' => $data->invoice_no)); ?>"><?php echo Yii::t("strings", "View"); ?></a>
                                <?php endif; ?>
                            </td>
                            <?php if ($this->hasUserAccess('purchase_delete') || $this->hasUserAccess('reset_invoice')): ?>
...
<div id="container_for_purchase" class="modal fade" tabindex="-1" role="dialog"></div>
