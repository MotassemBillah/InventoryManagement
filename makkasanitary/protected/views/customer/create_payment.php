...
$this->breadcrumbs = array(
    ...
    'Payment' => array(AppUrl::URL_CUSTOMER_PAYMENT, 'id' => $customer->_key),
    'Create'
);
?>
        ...
        <div class="row clearfix">
            <div class="col-md-4 col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" value="<?php echo AppObject::customerName($customer->id); ?>" class="form-control" readonly>
                </div>
                <div class="form-group">
                    <?php echo $form->labelEx($model, 'pay_date'); ?>
                    <div class="input-group">
                        <input type="text" id="datepickerExample" class="form-control" name="pay_date" value="<?php echo date('d-m-Y'); ?>" placeholder="(dd-mm-yyyy)" readonly>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                    </div>
                </div>
                <div class="form-group">
                    <?php echo $form->labelEx($model, 'Payment Type'); ?><br>
                    <label class="txt_np" for="due_paid" style="margin-right:10px;"><input value="<?php echo AppConstant::TYPE_DUE_PAID; ?>" id="due_paid" class="btn_pay_type" type="radio" name="pay_type" checked>&nbsp;<?php echo Yii::t('strings', 'Due Paid'); ?></label>
                    <label class="txt_np" for="due" style="margin-right:10px;"><input value="<?php echo AppConstant::TYPE_DUE; ?>" id="due" class="btn_pay_type" type="radio" name="pay_type">&nbsp;<?php echo Yii::t('strings', 'Previous Due'); ?></label>
