    ...
    <table width="100%">
        <tr>
            ...
            <td class="text-right wmd_30" style="position: relative;">
                <a class="btn btn-success btn-xs" href="<?php echo Yii::app()->createUrl(AppUrl::URL_SALERETURN_CREATE); ?>"><i class="fa fa-plus"></i>&nbsp;<?php echo Yii::t("strings", "New"); ?></a>
                <?php if ($this->hasUserAccess('sale_return_delete')): ?>
                        ...
                        <tr id="row_<?php echo $data->id; ?>">
                            ...
                            <td class="text-center">
                                <?php if ($data->status == AppConstant::ORDER_PENDING): ?>
                                    <?php if ($this->hasUserAccess('sale_return_edit')): ?>
                                        <a class="btn btn-info btn-xs" href="<?php echo $this->createUrl(AppUrl::URL_SALERETURN_EDIT, array('id' => $data->_key)); ?>"><?php echo Yii::t("strings", "Edit"); ?></a>
                                    <?php endif; ?>
                                    <?php if ($this->hasUserAccess('sale_return_process')): ?>
                                        <a class="btn btn-primary btn-xs process_order" href="javascript:void(0);" data-info="<?php echo $data->_key; ?>"><?php echo Yii::t("strings", "Process"); ?></a>
                                    <?php endif; ?>
                                <?php endif; ?>
                                <?php if ($this->hasUserAccess('sale_return_view')): ?>
                                    <a class="btn btn-primary btn-xs" href="<?php echo $this->createUrl(AppUrl::URL_SALERETURN_VIEW, array('id' => $data->return_invoice)); ?>"><?php echo Yii::t("strings", "Detail"); ?></a>
                                <?php endif; ?>
                            </td>
                            <?php if ($this->hasUserAccess('sale_return_delete')): ?>
