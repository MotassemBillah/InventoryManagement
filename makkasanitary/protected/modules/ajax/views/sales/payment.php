    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <div class="modal-title">
                <strong><u><?php echo Yii::t("strings", "Invoice Payment For "); ?></u>:</strong>&nbsp;<?php echo AppObject::customerName($model->customer_id); ?>
        ...
        <div class="modal-body" style="max-height:440px;overflow-y:auto;padding:5px 15px;">
            <div class="clearfix">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered tbl_invoice_view no_mrgn">
                        <tr>
                            <td style="width:40%;"><strong><?php echo Yii::t("strings", "Payment Method"); ?></strong></td>
                            <td class="text-right">
                        ...
                        <tr class="bank_option">
                            <td style="width:40%;"><strong><?php echo $form->labelEx($payment, 'bank_name'); ?></strong></td>
                            <td class="text-right"><?php echo $form->dropDownList($payment, 'bank_name', CHtml::listData($bankList, 'name', 'name'), array('empty' => 'Select', 'style' => 'float:right;width:100%')); ?></td>
                        </tr>
                        <tr class="bank_option">
                            <td style="width:40%;"><strong><?php echo $form->labelEx($payment, 'check_no'); ?></strong></td>
                            <td class="text-right"><?php echo $form->textField($payment, 'check_no', array('class' => 'text-right')); ?></td>
                        </tr>
                        <tr>
                            <td style="width:40%;"><strong><?php echo Yii::t("strings", "Invoice Amount"); ?></strong></td>
                        ...
                        <tr>
                            <td style="width:40%;"><strong><?php echo Yii::t("strings", "Transport Cost"); ?></strong></td>
                        ...
                        <tr>
                            <td style="width:40%;"><strong><?php echo Yii::t("strings", "Labor Cost"); ?></strong></td>
                        ...
                        <tr>
                            <td style="width:40%;"><strong><?php echo Yii::t("strings", "Discount Amount"); ?></strong></td>
                            <td class="text-right"><input type="text" class="text-right" name="txtLessAmount" id="txtLessAmount" value="<?php echo!empty($payment->discount_amount) ? AppHelper::getFloat($payment->discount_amount) : ""; ?>"<?php echo empty($payment->discount_amount) ? ' disabled="disabled"' : ""; ?>></td>
                        </tr>
                        <tr>
                            <td style="width:40%;"><strong><?php echo Yii::t("strings", "Net Payable"); ?></strong></td>
                            <td class="text-right"><input type="text" class="text-right" id="txtNetAmount" name="txtNetAmount" value="<?php echo AppHelper::getFloat($total - $payment->discount_amount); ?>"></td>
                        </tr>
                        <tr>
                            <td style="width:40%;"><strong><?php echo Yii::t("strings", "Paid Amount"); ?></strong></td>
                        ...
                        <tr>
                            <td style="width:40%;"><strong><?php echo Yii::t("strings", "Invoice Paid"); ?></strong></td>
                            <td class="text-right"><input type="text" class="text-right" id="txtPaidAmount" name="txtPaidAmount" value="<?php echo $invPaid; ?>" readonly></td>
                        </tr>
                        <tr>
                            <td style="width:40%;"><strong><?php echo Yii::t("strings", "Due Collection"); ?></strong></td>
